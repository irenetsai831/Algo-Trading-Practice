# "Market Neutral Trading Strategy" (Long&Short)
# Bollinger Bands has to do with mean reversion 
# it doesn't work in trends (bullish/bearish)
# Keywords: wiener process, ornstein uhlenbeck process, pair trading, mean reversion, cointegration
