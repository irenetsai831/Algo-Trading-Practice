# invest our capital into several stocks with given wi weights and rebalance daily
# it assumes the single stock prices will revert to the mean of portfolio (universe) e.g. S&P500
# short stocks with positive daily returns; long stocks with negative returns 
